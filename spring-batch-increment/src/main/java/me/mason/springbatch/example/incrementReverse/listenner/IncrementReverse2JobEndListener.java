 ...
 **/
@Slf4j
public class IncrementReverse2JobEndListener extends JobExecutionListenerSupport {
    ...
    public void afterJob(JobExecution jobExecution) {
        ...
        Date latestDate  = edgeUserRepository.selectMaxUpdateTime();
        cdcTempService.updateCdcTemp2AfterJob(SyncConstants.CDC_REVERSE_TEMP_ID_USER,status,latestDate);
    }
}
